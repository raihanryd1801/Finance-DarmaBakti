...
/* 1. Paksa Card & Input Form jadi Gelap */
...
/* 2. Libas semua div/tabel yang di-hardcode warna putih (#fff, #ffffff, white) */
...
/* 3. Libas header tabel yang di-hardcode abu-abu terang (#f8fafc) */
...
/* 4. Libas warna teks yang di-hardcode hitam pekat/gelap */
...
<aside class="sidebar">
    ...
    <ul class="sidebar-menu">
        <!-- MENU PUBLIK (BISA DILIHAT ADMIN & VIEWER) -->
        <li>
...
<div class="main-wrapper">
    <header class="main-header">
        ...
        <!-- BAGIAN KANAN HEADER: TOMBOL DARK MODE & NAMA PERUSAHAAN -->
...
// SCRIPT DARK MODE (tema sudah di-set lebih awal di <head>, di sini tinggal sinkronkan teks tombol)
(function(){
